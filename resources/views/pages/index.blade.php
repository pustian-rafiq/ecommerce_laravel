                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            ...
                                            <div class="product_content">
                                                ...
                                                @if($feature->discount_price==NULL)
                                                 <br><span class="text-danger"><b> ${{ $feature->selling_price }} </b></span>
                                                @else
                            ...
                            <div class="product_panel panel active">
                                <div class="featured_slider slider">
                                  ...
                                  <div class="featured_slider_item">
                                        <div class="border_active"></div>
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset($trend->image_one) }}" style="height: 120px; width: 130px" alt=""></div>
                                            <div class="product_content">
                                                <div class="product_price discount">$225<span>$300</span></div>
                                                <div class="product_name"><div><a href="#">{{ substr($trend->product_name, 0,20) }}</a></div></div>
                                                <div class="product_extras">
                            ...
                            <div class="product_panel panel active">
                                <div class="featured_slider slider">
                                  ...
                                  <div class="featured_slider_item">
                                        <div class="border_active"></div>
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset($best->image_one) }}" style="height: 120px; width: 130px" alt=""></div>
                                            <div class="product_content">
                                                <div class="product_price discount">$225<span>$300</span></div>
                                                <div class="product_name"><div><a href="#">{{ substr($best->product_name, 0,20) }}</a></div></div>
                                                <div class="product_extras">
                                                    <div class="product_color">
                                                        <input type="radio" checked name="product_color" style="background:#b19c83">
                                                        <input type="radio" name="product_color" style="background:#000000">
...
@endphp
 ...
 <!--Show related category--- Refrigerator--->
@php 
...
@endphp
 ...
 <!--When we click add to cart button this product cart add modal is opened-->
...
<!-- add to Cart -->
<!-- when we click add to cart button, a pop up modal is opened and show the below information using ajax.Finally we add the product into cart -->
<script type="text/javascript">
