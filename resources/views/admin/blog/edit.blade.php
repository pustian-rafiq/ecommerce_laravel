...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-tagsinput/0.8.0/bootstrap-tagsinput.css" crossorigin="anonymous">
    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
          ...
          <h6 class="card-body-title">Edit Post <a href="#" class="btn btn-success btn-sm pull-right">Edit Post</a></h6>
              ...
              <div class="col-lg-4">
                <div class="form-group mg-b-10-force">
                  ...
                  <select class="form-control select2" data-placeholder="Choose Category" name="category_id">
                    ...
                    <option value="{{ $row->id }}"<?php if($post->category_id == $row->id) echo "selected"; ?> >{{ $row->category_name_en }}</option>
                    @endforeach
                  </select>
                </div>
              </div><!-- col-4 -->
     ...
     {{-- Post Details for Bnagla --}}
              ...
              <img style="float: right;" src="{{ URL::to($post->post_image) }}" height="50">
      				  <img src="#" id="one" >
